...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'EduFund'); ?> — Crowdfunding Étudiant</title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center gap-6">
                <a href="<?php echo e(route('projects.index')); ?>" class="text-gray-600 hover:text-primary font-medium text-sm transition-colors">Projets</a>
                <a href="<?php echo e(route('partners.index')); ?>" class="text-gray-600 hover:text-primary font-medium text-sm transition-colors">Partenaires</a>
                <a href="<?php echo e(route('offers.index')); ?>" class="text-gray-600 hover:text-primary font-medium text-sm transition-colors">Opportunités</a>
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->isEtudiant()): ?>
                        <a href="<?php echo e(route('projects.create')); ?>" class="text-gray-600 hover:text-primary font-medium text-sm transition-colors">Créer un projet</a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
            ...
            <div class="flex items-center gap-3">
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn-outline text-sm py-2 px-4">Connexion</a>
                    <a href="<?php echo e(route('register')); ?>" class="btn-primary text-sm py-2 px-4">Inscription</a>
                <?php else: ?>
                    <!-- Notifications -->
                    <div class="relative">
                        ...
                        <div id="notif-dropdown" class="hidden absolute right-0 top-12 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 overflow-hidden">
                            <div class="p-4 border-b border-gray-100 flex items-center justify-between">
                                ...
                                <span class="badge badge-purple"><?php echo e(auth()->user()->unread_notifications_count); ?></span>
                            </div>
                            <div class="max-h-72 overflow-y-auto">
                                <?php $__empty_1 = true; $__currentLoopData = auth()->user()->notifications_custom()->latest()->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="p-3 hover:bg-gray-50 border-b border-gray-50 <?php echo e(!$notif->is_read ? 'bg-purple-50' : ''); ?>">
                                        <p class="text-xs font-semibold text-gray-800"><?php echo e($notif->title); ?></p>
                                        <p class="text-xs text-gray-500 mt-0.5"><?php echo e($notif->message); ?></p>
                    ...
                    <div class="relative">
                        <button id="user-menu-btn" class="flex items-center gap-2 hover:opacity-80 transition-opacity">
                            <img src="<?php echo e(auth()->user()->avatar_url); ?>" alt="" class="w-9 h-9 rounded-xl object-cover">
                            <div class="hidden md:block text-left">
                                <p class="text-xs font-semibold text-gray-800 leading-none"><?php echo e(Str::limit(auth()->user()->name, 15)); ?></p>
                                <p class="text-xs text-purple-600 font-medium capitalize mt-0.5"><?php echo e(auth()->user()->role); ?></p>
                            </div>
                        ...
                        <div id="user-dropdown" class="hidden absolute right-0 top-12 w-52 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 overflow-hidden py-2">
                            <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-purple-50 hover:text-primary transition-colors">
                                <i class="fas fa-th-large w-4 text-center"></i> Tableau de bord
                            </a>
                            <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-purple-50 hover:text-primary transition-colors">
                                <i class="fas fa-user w-4 text-center"></i> Mon profil
                            </a>
                            <?php if(auth()->user()->isEtudiant()): ?>
                            <a href="<?php echo e(route('projects.mine')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-purple-50 hover:text-primary transition-colors">
                                <i class="fas fa-folder w-4 text-center"></i> Mes projets
                            </a>
                            <?php endif; ?>
                            <?php if(auth()->user()->isContributeur()): ?>
                            <a href="<?php echo e(route('contributions.mine')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-purple-50 hover:text-primary transition-colors">
...
<footer class="bg-gray-900 text-white mt-24">
    <div class="max-w-7xl mx-auto px-4 py-16">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400 text-sm">
                    <li><a href="<?php echo e(route('projects.index')); ?>" class="hover:text-white transition-colors">Explorer les projets</a></li>
                    <li><a href="<?php echo e(route('partners.index')); ?>" class="hover:text-white transition-colors">Nos partenaires</a></li>
                    <li><a href="<?php echo e(route('offers.index')); ?>" class="hover:text-white transition-colors">Opportunités</a></li>
                </ul>
            </div>
            <div>
                <h4 class="font-display font-bold mb-4">Pour les étudiants</h4>
                <ul class="space-y-2 text-gray-400 text-sm">
                    <li><a href="<?php echo e(route('register')); ?>" class="hover:text-white transition-colors">Créer un projet</a></li>
        ...
        <div class="border-t border-gray-800 mt-12 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <p class="text-gray-500 text-sm">© <?php echo e(date('Y')); ?> EduFund. Tous droits réservés.</p>
...
<?php /**PATH C:\laragon\www\cofund-propre\resources\views/layouts/app.blade.php ENDPATH**/ ?>